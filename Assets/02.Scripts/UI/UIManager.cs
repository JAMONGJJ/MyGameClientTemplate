...
namespace ClientTemplate
{
    namespace UIRegion
    {
        ...
        public class UIManager : MonoManager<UIManager>
        {
            ...
            {
                Camera.main.GetUniversalAdditionalCameraData().cameraStack.Add(UISystem.UICamera);
            }
            ...
            public void LoadUISystem()
            {
                try
                {
                    ...
                    UISystem = GameObjectManager.Instance
                        .InstantiateGameObject(UIWindowAssetType.UISystem, Vector3.zero, Vector3.zero)
            ...
            public T OpenWindow<T>(UIWindowType windowType, UIData data = null) where T : UIWindow
            {
                try
                {
                    ...
                    GameObject windowGameObject = Instantiate(tmpObject, UISystem.GetUICanvasTransform(canvasType));
            ...
            {
                yield return null;
                UISystem.SetActiveLoadingWindow(true);
            }
            ...
            {
                yield return null;
                UISystem.SetActiveLoadingWindow(false);
            }
            ...
            {
                yield return null;
                UISystem.SetActiveWaitingWindow(true);
            }
            ...
            {
                yield return null;
                UISystem.SetActiveWaitingWindow(false);
            }
        }
    }
}
